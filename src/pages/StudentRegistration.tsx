...
export default function StudentRegistration() {
  const { register, handleSubmit, watch, reset, formState: { isSubmitting, errors } } = useForm<FormValuesStudent>();
          ...
          <List sx={ListStyle}>
            ...
            <Grid container spacing={2}>
              {fieldsTermosAvisos.map(({ label, id }) => (
                ...
                >
                  <Typography
                   sx={{ fontWeight: 'bold', color: '#333', marginBottom: 1,textAlign:"center" }}
                  >
                    {label}
                  </Typography>
                  <RadioGroup

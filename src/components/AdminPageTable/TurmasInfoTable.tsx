    ...
    <Box>
      ...
      <Divider/>
        <Table aria-label="collapsible table" >
          <TableHead>
            <TableRow >
              <TableCell sx={{border:"1px solid black"}} align="center">Nome da Turma</TableCell>
              <TableCell align="center" sx={{border:"1px solid black"}}>Modalidade</TableCell>
              <TableCell align="center"sx={{border:"1px solid black"}}>Núcleo</TableCell>
              <TableCell align="center"sx={{border:"1px solid black"}}>Categoria</TableCell>
              <TableCell align="center"sx={{border:"1px solid black"}}>Número de Alunos</TableCell>
              <TableCell align="center"sx={{border:"1px solid black"}}>Vagas Disponíveis</TableCell>
              <TableCell align="center"sx={{border:"1px solid black"}}>Capacidade Atual</TableCell>
              <TableCell align="center"sx={{border:"1px solid black"}}>Capacidade Máxima</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {filteredRows.map((row, index) => (
              <React.Fragment key={index}>
                ...
                >
                  <TableCell sx={{border:"1px solid black"}} align="center">{row.nome_da_turma}</TableCell>
                  <TableCell sx={{border:"1px solid black"}} align="center">{row.modalidade}</TableCell>
                  <TableCell sx={{border:"1px solid black"}} align="center">{row.nucleo}</TableCell>
                  <TableCell sx={{border:"1px solid black"}} align="center">{row.categoria}</TableCell>
...
/*
 <Box sx={modalStyleAdmin}>
            {selectedTurma && (
              <ControleFrequenciaTable
                alunosDaTurma={selectedTurma.alunos}
                nomeDaTurma={selectedTurma.nome_da_turma}
              />
            )}
